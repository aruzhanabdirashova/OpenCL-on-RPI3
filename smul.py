...
with open("sum_mul.cl", "r") as f_kernel:
...
res_add = cl.Buffer(ctx, mf.WRITE_ONLY, a_np.nbytes)
res_mull = cl.Buffer(ctx, mf.WRITE_ONLY, a_np.nbytes)
...
sum_knl = prg.sum_mul
sum_knl.set_args(a_g, b_g, res_add, res_mull)
local_work_size = (8,)
#local_work_size = (10,)
...
cl.enqueue_copy(queue, res_np1, res_mull)
...
res_local = a_np + b_np
res_local1 = a_np*b_np
t4 = time.process_time_ns()

print("Comparing results")
print("Difference :{}".format(res_np1 - res_local1))
print(a_np[0:5])
print(b_np[0:5])
print(res_np1[0:5])
print(res_local1[0:5])

print("Checking the norm between both: {}".format(np.linalg.norm(res_np1 - 
res_local1)))

print("Checking results are mostly the same", np.allclose(res_np1, 
res_local1))
